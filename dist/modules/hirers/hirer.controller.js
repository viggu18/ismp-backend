...
const hirerService = __importStar(require("./hirer.service"));
const getMyProfile = async (req, res) => {
    const profile = await hirerService.getMyProfile(req.currentUser.userId);
    return (0, response_1.sendSuccess)(res, profile, "Hirer profile fetched");
};
...
const upsertMyProfile = async (req, res) => {
    ...
    return (0, response_1.sendSuccess)(res, profile, "Hirer profile saved");
};
