...
notificationRouter.get("/", (0, async_handler_1.asyncHandler)(notificationController.listNotifications));
notificationRouter.post("/:notificationId/read", (0, validate_middleware_1.validate)({ params: notificationIdParamSchema }), (0, async_handler_1.asyncHandler)(notificationController.markNotificationRead));
